...
Für solche Problemklassen eignen sich evolutionäre Verfahren, da sie ohne Ableitungsinformation auskommen, mit gemischten Datentypen umgehen können und in vertretbarer Rechenzeit gute Näherungslösungen liefern \parencite[Vgl.]{eibenSmithIntroductionEvolutionary2015}. In dieser Arbeit wird daher ein genetischer Algorithmus entworfen: Ein Reiseplan wird als Genstring aus Quadrupeln (Reiseziel, Aufenthaltsdauer, Verbindung und Hotel) kodiert und über eine gewichtete Fitnessfunktion aus Kosten, Diskomfort und CO\textsubscript{2} bewertet, deren Gewichte die Präferenzen der reisenden Person abbilden. Problemspezifische Mutations- und Crossover-Operatoren berücksichtigen dabei die unterschiedliche Struktur der Genabschnitte, insbesondere den Permutationscharakter der Reihenfolge.
